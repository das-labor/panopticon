...
mod tests {
    ...
    fn empty() {
        ...
        // assert_eq!(func.cfg.num_vertices(), 1);
        // assert_eq!(func.cfg.num_edges(), 0);
        // assert_eq!(func.name, "func_0x0".to_string());

        // let vx = func.cfg.vertices().next().unwrap();
        // if let Some(&ControlFlowTarget::Failed(v, _)) = func.cfg.vertex_label(vx) {
        //     assert_eq!(v, 0);
        // }
    }

...
use {Bound, Layer, OpaqueLayer, LayerIter, Result};
...
mod tests {
    ...
    fn projection() {
        ...
        let expect = vec![(Bound::new(0, 16), f.0), (Bound::new(0, 48), f.2), (Bound::new(32, 64), f.1), (Bound::new(96, 128), f.0)];
    ...
    fn read_one_layer() {
        if let Ok(ref tmpdir) = TempDir::new("test-panop") {
            ...
            assert!(r1.cover(Bound::new(50, 62),

...
pub fn integer_universial(imm8: Arc<Disassembler<Amd64>>,
    ...
    new_disassembler!(Amd64 =>
        ...
        // Jcc
        [ 0x70, imm8      ] = branch("jo",decode_rel,Condition::Overflow),
        [ 0x71, imm8      ] = branch("jno",decode_rel,Condition::NotOverflow),
        [ 0x72, imm8      ] = branch("jc",decode_rel,Condition::Carry),
        [ 0x73, imm8      ] = branch("jae",decode_rel,Condition::AboveEqual),
        [ 0x74, imm8      ] = branch("je",decode_rel,Condition::Equal),
        [ 0x75, imm8      ] = branch("jne",decode_rel,Condition::NotEqual),
        [ 0x76, imm8      ] = branch("jbe",decode_rel,Condition::BelowEqual),
        [ 0x77, imm8      ] = branch("ja",decode_rel,Condition::Above),
        [ 0x78, imm8      ] = branch("js",decode_rel,Condition::Sign),
        [ 0x79, imm8      ] = branch("jns",decode_rel,Condition::NotSign),
        [ 0x7a, imm8      ] = branch("jp",decode_rel,Condition::Parity),
        [ 0x7b, imm8      ] = branch("jnp",decode_rel,Condition::NotParity),
        [ 0x7c, imm8      ] = branch("jl",decode_rel,Condition::Less),
        [ 0x7d, imm8      ] = branch("jge",decode_rel,Condition::GreaterEqual),
        [ 0x7e, imm8      ] = branch("jle",decode_rel,Condition::LessEqual),
        [ 0x7f, imm8      ] = branch("jg",decode_rel,Condition::Greater),

        [ 0x0f, 0x80, imm ] = branch("jo",decode_rel,Condition::Overflow),
        [ 0x0f, 0x81, imm ] = branch("jno",decode_rel,Condition::NotOverflow),
        [ 0x0f, 0x82, imm ] = branch("jc",decode_rel,Condition::Carry),
        [ 0x0f, 0x83, imm ] = branch("jae",decode_rel,Condition::AboveEqual),
        [ 0x0f, 0x84, imm ] = branch("je",decode_rel,Condition::Equal),
        [ 0x0f, 0x85, imm ] = branch("jne",decode_rel,Condition::NotEqual),
        [ 0x0f, 0x86, imm ] = branch("jbe",decode_rel,Condition::BelowEqual),
        [ 0x0f, 0x87, imm ] = branch("ja",decode_rel,Condition::Above),
        [ 0x0f, 0x88, imm ] = branch("js",decode_rel,Condition::Sign),
        [ 0x0f, 0x89, imm ] = branch("jns",decode_rel,Condition::NotSign),
        [ 0x0f, 0x8a, imm ] = branch("jp",decode_rel,Condition::Parity),
        [ 0x0f, 0x8b, imm ] = branch("jnp",decode_rel,Condition::NotParity),
        [ 0x0f, 0x8c, imm ] = branch("jl",decode_rel,Condition::Less),
        [ 0x0f, 0x8d, imm ] = branch("jge",decode_rel,Condition::GreaterEqual),
        [ 0x0f, 0x8e, imm ] = branch("jle",decode_rel,Condition::LessEqual),
        [ 0x0f, 0x8f, imm ] = branch("jg",decode_rel,Condition::Greater),

use amd64::{Opcode, OperandSpec, OperandType, AddressingMethod, MnemonicSpec, OpcodeOption};
use amd64::semantic;
...
pub static ONEBYTE_TABLE: [Opcode; 256] = [opcode!(add; E/b, G/b), // 0x00: add
                                           ...
                                           opcode!(imul3 ("imul"); G/v, E/v, I/z), // 0x69: imul
                                           opcode!(push; I/b; Default64), // 0x6a: push
                                           opcode!(imul3 ("imul"); G/v, E/v, I/b), // 0x6b: imul
                                           ...
                                           opcode!(retn; I/w; Force64), // 0xc2: ret
                                           ...
                                           Opcode::Unary(MnemonicSpec::Single("loop"),
                                           ...
                                           Opcode::Binary(MnemonicSpec::Single("in"),
                                                          OpcodeOption::None,
...
pub static TWOBYTE_TABLE: [Opcode; 256] = [opcode!(group 6; ), // 0x00
                                           opcode!(group 7; ), // 0x01
                                           ...
                                           unused!(), // 0x0e
                                           unused!(), // 0x0f
                                           opcode!(movups; V/ps, W/ps), // 0x10: movups
                                           opcode!(movups; W/ps, V/ps), // 0x11: movups
                                           opcode!(vmovlps; V/q, H/q, M/q), // 0x12: movlps
                                           opcode!(movlps; M/q, V/q), // 0x13: movlps
                                           ...
                                           opcode!(movhps; M/q, V/q), // 0x17: movhps
                                           ...
                                           unused!(), // 0x26
                                           unused!(), // 0x27
                                           opcode!(movaps; V/ps, W/ps), // 0x28: movaps
                                           opcode!(movaps; W/ps, V/ps), // 0x29: movaps
                                           opcode!(cvtpi2ps; V/ps, Q/pi), // 0x2a: cvtpi2ps
                                           opcode!(movntps; M/ps, V/ps), // 0x2b: movntps
                                           opcode!(cvttps2pi; P/pi, W/ps), // 0x2c: cvttps2pi
                                           opcode!(cvtps2pi; P/ps, W/ps), // 0x2d: cvtps2pi
                                           opcode!(ucomiss; V/ss, W/ss), // 0x2e: ucomiss
                                           opcode!(comiss; V/ss, W/ss), // 0x2f: comiss
                                           ...
                                           opcode!(movmskps; G/y, U/ps), // 0x50: movmskps
                                           opcode!(sqrtps; V/ps, W/ps), // 0x51: sqrtps
                                           opcode!(rsqrtps; V/ps, W/ps), // 0x52: rsqrtps
                                           opcode!(rcpps; V/ps, W/ps), // 0x53: rcpps
                                           ...
                                           opcode!(cvtps2pd; V/pd, W/ps), // 0x5a: cvtps2pd
                                           opcode!(cvtdq2ps; V/ps, W/dq), // 0x5b: cvtdq2ps
                                           ...
                                           opcode!(vpshufw; P/q, Q/q, I/b), // 0x70: pshufw
                                           ...
                                           opcode!(vshld; E/v, G/v, I/b), // 0xa4: shld
                                           opcode!(vshld; E/v, G/v, CL), // 0xa5: shld
                                           ...
                                           opcode!(vshrd; E/v, G/v, I/b), // 0xac: shrd
                                           opcode!(vshrd; E/v, G/v, CL), // 0xad: shrd
                                           opcode!(group 15; ), // 0xae: clflush
                                           opcode!(imul2 ("imul"); G/v, E/v), // 0xaf: imul
...
pub static TWOBYTE_66_TABLE: [Opcode; 256] = [unused!(), // 0x00
                                              unused!(), // 0x01
                                              unused!(), // 0x02
                                              unused!(), // 0x03
                                              unused!(), // 0x04
                                              ...
                                              unused!(), // 0x0e
                                              unused!(), // 0x0f
                                              opcode!(movupd; V/pd, W/pd), // 0x10: movupd
                                              opcode!(movupd; W/pd, V/pd), // 0x11: movupd
                                              opcode!(vmovlpd; V/q, H/q, M/q), // 0x12: movlpd
                                              opcode!(movlpd; M/q, V/q), // 0x13: movlpd
                                              ...
                                              unused!(), // 0x26
                                              unused!(), // 0x27
                                              opcode!(movapd; V/pd, W/pd), // 0x28: movapd
                                              opcode!(movapd; W/pd, V/pd), // 0x29: movapd
                                              opcode!(cvtpi2pd; V/pd, Q/pi), // 0x2a: cvtpi2pd
                                              opcode!(movntpd; M/pd, V/pd), // 0x2b: movntpd
                                              opcode!(cvttpd2pi; P/pi, W/pd), // 0x2c: cvttpd2pi
                                              opcode!(cvtpd2pi; Q/pi, W/pd), // 0x2d: cvtpd2pi
                                              opcode!(ucomisd; V/sd, W/sd), // 0x2e: ucomisd
                                              opcode!(comisd; V/sd, W/sd), // 0x2f: comisd
                                              unused!(), // 0x30
                                              unused!(), // 0x31
                                              unused!(), // 0x32
                                              unused!(), // 0x33
                                              ...
                                              unused!(), // 0x4e
                                              unused!(), // 0x4f
                                              opcode!(movmskpd; G/d, U/pd), // 0x50: movmskpd
                                              opcode!(sqrtpd; V/pd, W/pd), // 0x51: sqrtpd
                                              unused!(), // 0x52
                                              unused!(), // 0x53
                                              ...
                                              opcode!(vpunpckhbw; V/x, H/x, W/x), // 0x68: punpckhbw
                                              opcode!(vpunpckhwd; V/x, H/x, W/x), // 0x69: punpckhwd
                                              opcode!(vpunpckhdq; V/x, H/x, W/x), // 0x6a: punpckhdq
                                              opcode!(vpackssdw; V/x, H/x, W/x), // 0x6b: packssdw
                                              opcode!(vpunpcklqdq; V/x, H/x, W/x), // 0x6c: punpcklqdq
                                              opcode!(vpunpckhqdq; V/x, H/x, W/x), // 0x6d: punpckhqdq
                                              opcode!(vmovd; V/y, E/y), // 0x6e: movd
                                              opcode!(movdqa; V/x, W/x), // 0x6f: movdqa
                                              opcode!(vpshufd; V/x, W/x, I/b), // 0x70: pshufd
                                              opcode!(group 12; ), // 0x71: psllw
                                              opcode!(group 13; ), // 0x72: pslld
                                              opcode!(group 14; ), // 0x73: psllq
                                              ...
                                              unused!(), // 0x7a
                                              unused!(), // 0x7b
                                              opcode!(vhaddpd; V/pd, H/pd, W/pd), // 0x7c: haddpd
                                              opcode!(vhsubpd; V/pd, H/pd, W/pd), // 0x7d: hsubpd
                                              opcode!(vmovd; E/y, V/y), // 0x7e: movd
                                              ...
                                              opcode!(movq; W/q, V/q), // 0xd6: movq
                                              opcode!(pmovmskb; G/d, U/x), // 0xd7: pmovmskb
                                              ...
                                              unused!(), // 0xf0
                                              opcode!(psllw; V/x, W/x), // 0xf1: psllw
                                              opcode!(pslld; V/x, W/x), // 0xf2: pslld
                                              opcode!(psllq; V/x, W/x), // 0xf3: psllq
                                              opcode!(pmuludq; V/x, W/x), // 0xf4: pmuludq
                                              opcode!(vpmaddwd; V/x, H/x, W/x), // 0xf5: pmaddwd
                                              opcode!(vpsadbw; V/x, H/x, W/x), // 0xf6: psadbw
                                              opcode!(maskmovdqu; V/dq, U/dq), // 0xf7: maskmovdqu
...
pub static TWOBYTE_F3_TABLE: [Opcode; 256] = [unused!(), // 0x00
                                              unused!(), // 0x01
                                              unused!(), // 0x02
                                              unused!(), // 0x03
                                              unused!(), // 0x04
                                              ...
                                              opcode!(movsldup; V/x, W/x), // 0x12: movsldup
                                              unused!(), // 0x13
                                              unused!(), // 0x14
                                              unused!(), // 0x15
                                              opcode!(movshdup; V/x, W/x), // 0x16: movshdup
                                              unused!(), // 0x17
                                              unused!(), // 0x18
                                              unused!(), // 0x19
                                              unused!(), // 0x1a
                                              ...
                                              unused!(), // 0x28
                                              unused!(), // 0x29
                                              opcode!(vcvtsi2ss; V/ss, H/ss, E/y), // 0x2a: cvtsi2ss
                                              unused!(), // 0x2b
                                              ...
                                              opcode!(cvttps2dq; V/dq, W/ps), // 0x5b: cvttps2dq
                                              ...
                                              opcode!(vpshufhw; V/x, W/x, I/b), // 0x70: pshufhw
                                              unused!(), // 0x71
                                              unused!(), // 0x72
                                              unused!(), // 0x73
                                              unused!(), // 0x74
                                              ...
                                              unused!(), // 0xd4
                                              unused!(), // 0xd5
                                              opcode!(vmovq2dq; V/dq, N/q), // 0xd6: movq2dq
                                              unused!(), // 0xd7
                                              unused!(), // 0xd8
                                              unused!(), // 0xd9
                                              unused!(), // 0xda
...
pub static TWOBYTE_F2_TABLE: [Opcode; 256] = [unused!(), // 0x00
                                              unused!(), // 0x01
                                              unused!(), // 0x02
                                              unused!(), // 0x03
                                              unused!(), // 0x04
                                              ...
                                              opcode!(movddup; V/x, W/x), // 0x12: movddup
                                              unused!(), // 0x13
                                              unused!(), // 0x14
                                              unused!(), // 0x15
                                              unused!(), // 0x16
                                              ...
                                              unused!(), // 0x28
                                              unused!(), // 0x29
                                              opcode!(vcvtsi2sd; V/sd, H/sd, E/y), // 0x2a: cvtsi2sd
                                              unused!(), // 0x2b
                                              ...
                                              unused!(), // 0x6e
                                              unused!(), // 0x6f
                                              opcode!(vpshuflw; V/x, W/x, I/b), // 0x70: pshuflw
                                              unused!(), // 0x71
                                              unused!(), // 0x72
                                              unused!(), // 0x73
                                              unused!(), // 0x74
                                              ...
                                              unused!(), // 0x7a
                                              unused!(), // 0x7b
                                              opcode!(vhaddps; V/ps, H/ps, W/ps), // 0x7c: haddps
                                              opcode!(vhsubps; V/ps, H/ps, W/ps), // 0x7d: hsubps
                                              unused!(), // 0x7e
                                              unused!(), // 0x7f
                                              unused!(), // 0x80
                                              unused!(), // 0x81
...
pub static THREEBYTE_38_TABLE: [Opcode; 256] = [opcode!(pshufb; P/q, Q/q), // 0x00: pshufb
                                                ...
                                                opcode!(vandn; G/y, B/y, E/y), // 0xf2
                                                unused!(), // 0xf3
                                                unused!(), // 0xf4
                                                opcode!(vbzhi; G/y, E/y, B/y), // 0xf5
                                                unused!(), // 0xf6
                                                opcode!(vbextr; G/y, E/y, B/y), // 0xf7
                                                unused!(), // 0xf8
                                                unused!(), // 0xf9
                                                unused!(), // 0xfa
                                                unused!(), // 0xfb
...
pub static THREEBYTE_3866_TABLE: [Opcode; 256] = [opcode!(vpshufb; V/x, H/x, W/x), // 0x00: pshufb
                                                  opcode!(vphaddw; V/x, H/x, W/x), // 0x01: phaddw
                                                  opcode!(vphaddd; V/x, H/x, W/x), // 0x02: phaddd
                                                  opcode!(vphaddsw; V/x, H/x, W/x), // 0x03: phaddsw
                                                  opcode!(vpmaddubsw; V/x, H/x, W/x), // 0x04: pmaddubsw
                                                  ...
                                                  opcode!(testps; V/x, W/x), // 0x0e
                                                  opcode!(testpd; V/x, W/x), // 0x0f
                                                  ...
                                                  opcode!(broadcastss; V/x, W/d), // 0x18
                                                  opcode!(broadcastsd; W/q), // 0x19
                                                  opcode!(broadcastf128; M/dq), // 0x1a
                                                  unused!(), // 0x1b
                                                  opcode!(pabsb; V/x, W/x), // 0x1c: pabsb
                                                  opcode!(pabsw; V/x, W/x), // 0x1d: pabsw
                                                  opcode!(pabsd; V/x, W/x), // 0x1e: pabsd
                                                  unused!(), // 0x1f
                                                  ...
                                                  opcode!(movntdqa; V/x, M/dq), // 0x2a: movntdqa
                                                  ...
                                                  opcode!(vpcmpgtq; V/x, H/x, W/x), // 0x37: pcmpgtq
                                                  ...
                                                  opcode!(vpmulld; V/x, H/x, W/x), // 0x40: pmulld
                                                  ...
                                                  unused!(), // 0x56
                                                  unused!(), // 0x57
                                                  opcode!(pbroadcastd; V/x, W/x), // 0x58
                                                  opcode!(pbroadcastq; V/x, W/x), // 0x59
                                                  opcode!(broadcasti128; V/dq, W/dq), // 0x5a
                                                  unused!(), // 0x5b
                                                  unused!(), // 0x5c
                                                  unused!(), // 0x5d
                                                  unused!(), // 0x5e
                                                  ...
                                                  unused!(), // 0x76
                                                  unused!(), // 0x77
                                                  opcode!(pbroadcastb; V/x, W/x), // 0x78
                                                  opcode!(pboradcastw; V/x, W/x), // 0x79
                                                  unused!(), // 0x7a
                                                  unused!(), // 0x7b
                                                  unused!(), // 0x7c
                                                  unused!(), // 0x7d
                                                  ...
                                                  opcode!(vaesenclast; V/dq, H/dq, W/dq), // 0xdd: aesenclast
                                                  opcode!(vaesdec; V/dq, H/dq, W/dq), // 0xde: aesdec
...
pub static THREEBYTE_38F2_TABLE: [Opcode; 256] = [unused!(), // 0x00
                                                  unused!(), // 0x01
                                                  unused!(), // 0x02
                                                  unused!(), // 0x03
                                                  unused!(), // 0x04
...
pub static THREEBYTE_38F3_TABLE: [Opcode; 256] =
    [unused!() /* 0x00 */, unused!() /* 0x01 */, unused!() /* 0x02 */, unused!() /* 0x03 */, unused!() /* 0x04 */, unused!() /* 0x05 */, unused!() /* 0x06 */, unused!() /* 0x07 */, unused!() /* 0x08 */, unused!() /* 0x09 */,
     unused!() /* 0x0a */, unused!() /* 0x0b */, unused!() /* 0x0c */, unused!() /* 0x0d */, unused!() /* 0x0e */, unused!() /* 0x0f */, unused!() /* 0x10 */, unused!() /* 0x11 */, unused!() /* 0x12 */, unused!() /* 0x13 */,
     unused!() /* 0x14 */, unused!() /* 0x15 */, unused!() /* 0x16 */, unused!() /* 0x17 */, unused!() /* 0x18 */, unused!() /* 0x19 */, unused!() /* 0x1a */, unused!() /* 0x1b */, unused!() /* 0x1c */, unused!() /* 0x1d */,
     unused!() /* 0x1e */, unused!() /* 0x1f */, unused!() /* 0x20 */, unused!() /* 0x21 */, unused!() /* 0x22 */, unused!() /* 0x23 */, unused!() /* 0x24 */, unused!() /* 0x25 */, unused!() /* 0x26 */, unused!() /* 0x27 */,
     unused!() /* 0x28 */, unused!() /* 0x29 */, unused!() /* 0x2a */, unused!() /* 0x2b */, unused!() /* 0x2c */, unused!() /* 0x2d */, unused!() /* 0x2e */, unused!() /* 0x2f */, unused!() /* 0x30 */, unused!() /* 0x31 */,
     unused!() /* 0x32 */, unused!() /* 0x33 */, unused!() /* 0x34 */, unused!() /* 0x35 */, unused!() /* 0x36 */, unused!() /* 0x37 */, unused!() /* 0x38 */, unused!() /* 0x39 */, unused!() /* 0x3a */, unused!() /* 0x3b */,
     unused!() /* 0x3c */, unused!() /* 0x3d */, unused!() /* 0x3e */, unused!() /* 0x3f */, unused!() /* 0x40 */, unused!() /* 0x41 */, unused!() /* 0x42 */, unused!() /* 0x43 */, unused!() /* 0x44 */, unused!() /* 0x45 */,
     unused!() /* 0x46 */, unused!() /* 0x47 */, unused!() /* 0x48 */, unused!() /* 0x49 */, unused!() /* 0x4a */, unused!() /* 0x4b */, unused!() /* 0x4c */, unused!() /* 0x4d */, unused!() /* 0x4e */, unused!() /* 0x4f */,
     unused!() /* 0x50 */, unused!() /* 0x51 */, unused!() /* 0x52 */, unused!() /* 0x53 */, unused!() /* 0x54 */, unused!() /* 0x55 */, unused!() /* 0x56 */, unused!() /* 0x57 */, unused!() /* 0x58 */, unused!() /* 0x59 */,
     unused!() /* 0x5a */, unused!() /* 0x5b */, unused!() /* 0x5c */, unused!() /* 0x5d */, unused!() /* 0x5e */, unused!() /* 0x5f */, unused!() /* 0x60 */, unused!() /* 0x61 */, unused!() /* 0x62 */, unused!() /* 0x63 */,
     unused!() /* 0x64 */, unused!() /* 0x65 */, unused!() /* 0x66 */, unused!() /* 0x67 */, unused!() /* 0x68 */, unused!() /* 0x69 */, unused!() /* 0x6a */, unused!() /* 0x6b */, unused!() /* 0x6c */, unused!() /* 0x6d */,
     unused!() /* 0x6e */, unused!() /* 0x6f */, unused!() /* 0x70 */, unused!() /* 0x71 */, unused!() /* 0x72 */, unused!() /* 0x73 */, unused!() /* 0x74 */, unused!() /* 0x75 */, unused!() /* 0x76 */, unused!() /* 0x77 */,
     unused!() /* 0x78 */, unused!() /* 0x79 */, unused!() /* 0x7a */, unused!() /* 0x7b */, unused!() /* 0x7c */, unused!() /* 0x7d */, unused!() /* 0x7e */, unused!() /* 0x7f */, unused!() /* 0x80 */, unused!() /* 0x81 */,
     unused!() /* 0x82 */, unused!() /* 0x83 */, unused!() /* 0x84 */, unused!() /* 0x85 */, unused!() /* 0x86 */, unused!() /* 0x87 */, unused!() /* 0x88 */, unused!() /* 0x89 */, unused!() /* 0x8a */, unused!() /* 0x8b */,
     unused!() /* 0x8c */, unused!() /* 0x8d */, unused!() /* 0x8e */, unused!() /* 0x8f */, unused!() /* 0x90 */, unused!() /* 0x91 */, unused!() /* 0x92 */, unused!() /* 0x93 */, unused!() /* 0x94 */, unused!() /* 0x95 */,
     unused!() /* 0x96 */, unused!() /* 0x97 */, unused!() /* 0x98 */, unused!() /* 0x99 */, unused!() /* 0x9a */, unused!() /* 0x9b */, unused!() /* 0x9c */, unused!() /* 0x9d */, unused!() /* 0x9e */, unused!() /* 0x9f */,
     unused!() /* 0xa0 */, unused!() /* 0xa1 */, unused!() /* 0xa2 */, unused!() /* 0xa3 */, unused!() /* 0xa4 */, unused!() /* 0xa5 */, unused!() /* 0xa6 */, unused!() /* 0xa7 */, unused!() /* 0xa8 */, unused!() /* 0xa9 */,
     unused!() /* 0xaa */, unused!() /* 0xab */, unused!() /* 0xac */, unused!() /* 0xad */, unused!() /* 0xae */, unused!() /* 0xaf */, unused!() /* 0xb0 */, unused!() /* 0xb1 */, unused!() /* 0xb2 */, unused!() /* 0xb3 */,
     unused!() /* 0xb4 */, unused!() /* 0xb5 */, unused!() /* 0xb6 */, unused!() /* 0xb7 */, unused!() /* 0xb8 */, unused!() /* 0xb9 */, unused!() /* 0xba */, unused!() /* 0xbb */, unused!() /* 0xbc */, unused!() /* 0xbd */,
     unused!() /* 0xbe */, unused!() /* 0xbf */, unused!() /* 0xc0 */, unused!() /* 0xc1 */, unused!() /* 0xc2 */, unused!() /* 0xc3 */, unused!() /* 0xc4 */, unused!() /* 0xc5 */, unused!() /* 0xc6 */, unused!() /* 0xc7 */,
     unused!() /* 0xc8 */, unused!() /* 0xc9 */, unused!() /* 0xca */, unused!() /* 0xcb */, unused!() /* 0xcc */, unused!() /* 0xcd */, unused!() /* 0xce */, unused!() /* 0xcf */, unused!() /* 0xd0 */, unused!() /* 0xd1 */,
     unused!() /* 0xd2 */, unused!() /* 0xd3 */, unused!() /* 0xd4 */, unused!() /* 0xd5 */, unused!() /* 0xd6 */, unused!() /* 0xd7 */, unused!() /* 0xd8 */, unused!() /* 0xd9 */, unused!() /* 0xda */, unused!() /* 0xdb */,
     unused!() /* 0xdc */, unused!() /* 0xdd */, unused!() /* 0xde */, unused!() /* 0xdf */, unused!() /* 0xe0 */, unused!() /* 0xe1 */, unused!() /* 0xe2 */, unused!() /* 0xe3 */, unused!() /* 0xe4 */, unused!() /* 0xe5 */,
     unused!() /* 0xe6 */, unused!() /* 0xe7 */, unused!() /* 0xe8 */, unused!() /* 0xe9 */, unused!() /* 0xea */, unused!() /* 0xeb */, unused!() /* 0xec */, unused!() /* 0xed */, unused!() /* 0xee */, unused!() /* 0xef */,
     unused!() /* 0xf0 */, unused!() /* 0xf1 */, unused!() /* 0xf2 */, unused!() /* 0xf3 */, unused!() /* 0xf4 */, unused!() /* 0xf5 */, unused!() /* 0xf6 */, unused!() /* 0xf7 */, unused!() /* 0xf8 */, unused!() /* 0xf9 */,
     unused!() /* 0xfa */, unused!() /* 0xfb */, unused!() /* 0xfc */, unused!() /* 0xfd */, unused!() /* 0xfe */, unused!() /* 0xff */];

pub static THREEBYTE_3A_TABLE: [Opcode; 256] = [unused!(), // 0x00
                                                unused!(), // 0x01
                                                unused!(), // 0x02
                                                unused!(), // 0x03
                                                unused!(), // 0x04
                                                ...
                                                unused!(), // 0xca
                                                unused!(), // 0xcb
                                                opcode!(vsha1rnds4; V/dq, W/dq, I/b), // 0xcc
                                                unused!(), // 0xcd
                                                unused!(), // 0xce
                                                unused!(), // 0xcf
                                                unused!(), // 0xd0
...
pub static THREEBYTE_3A66_TABLE: [Opcode; 256] = [opcode!(vpermq; V/qq, W/qq, I/b), // 0x00
...
pub static THREEDNOW_TABLE: [Opcode; 256] = [unused!(), // 0x00
                                             unused!(), // 0x01
                                             unused!(), // 0x02
                                             unused!(), // 0x03
                                             unused!(), // 0x04
...
pub static GROUP1_OPC80: [Opcode; 8] = [opcode!(add; E/b, I/b), // 0x00: add
...
pub static GROUP1_OPC81: [Opcode; 8] = [opcode!(add; E/v, I/z), // 0x00: add
...
pub static GROUP1_OPC82: [Opcode; 8] = [opcode!(add; E/b, I/b), // 0x00: add
                                        opcode!(or; E/b, I/b), // 0x01: or
                                        opcode!(adc; E/b, I/b), // 0x02: adc
                                        opcode!(sbb; E/b, I/b), // 0x03: sbb
                                        opcode!(and; E/b, I/b), // 0x04: and
                                        ...
                                        opcode!(xor; E/b, I/b), // 0x06: xor
                                        opcode!(cmp; E/b, I/b) /* 0x07: cmp */];
pub static GROUP1_OPC83: [Opcode; 8] = [opcode!(add; E/v, I/b), // 0x00: add
...
// GROUP1A_OPC8F
pub static GROUP101_OPC8F: [Opcode; 8] = [opcode!(pop; E/v) /* 0x00: pop */, unused!(), unused!(), unused!(), unused!(), unused!(), unused!(), unused!()];

pub static GROUP2_OPCC0: [Opcode; 8] = [opcode!(rol; E/b, I/b), // 0x00: rol
...
pub static GROUP2_OPCC1: [Opcode; 8] = [opcode!(rol; E/v, I/b), // 0x00: rol
...
pub static GROUP2_OPCD0: [Opcode; 8] = [opcode!(rol; E/b, I/one), // 0x00: rol
...
pub static GROUP2_OPCD1: [Opcode; 8] = [opcode!(rol; E/v, I/one), // 0x00: rol
...
pub static GROUP2_OPCD2: [Opcode; 8] = [opcode!(rol; E/b, CL), // 0x00: rol
...
pub static GROUP2_OPCD3: [Opcode; 8] = [opcode!(rol; E/v, CL), // 0x00: rol
...
pub static GROUP3_OPCF6: [Opcode; 8] = [opcode!(test; E/b, I/b), // 0x00: test
                                        opcode!(test; E/b, I/b), // 0x01: test
                                        opcode!(not; E/b), // 0x02: not
                                        opcode!(neg; E/b), // 0x03: neg
                                        opcode!(mul; E/b), // 0x04: mul
                                        opcode!(imul1 ("imul"); E/b), // 0x05: imul
                                        opcode!(div; E/b), // 0x06: div
                                        opcode!(idiv; E/b) /* 0x07: idiv */];

pub static GROUP3_OPCF7: [Opcode; 8] = [opcode!(test; E/v, I/z), // 0x00: test
                                        opcode!(test; E/v, I/z), // 0x01: test
                                        opcode!(not; E/v), // 0x02: not
                                        opcode!(neg; E/v), // 0x03: neg
                                        opcode!(mul; E/v), // 0x04: mul
                                        opcode!(imul1 ("imul"); E/v), // 0x05: imul
                                        opcode!(div; E/v), // 0x06: div
                                        opcode!(idiv; E/v) /* 0x07: idiv */];

pub static GROUP4_OPCFE: [Opcode; 8] = [opcode!(inc; E/b) /* 0x00: inc */, opcode!(dec; E/b) /* 0x01: dec */, unused!() /* 0x02 */, unused!() /* 0x03 */, unused!() /* 0x04 */, unused!() /* 0x05 */, unused!() /* 0x06 */, unused!() /* 0x07 */];

pub static GROUP5_OPCFF: [Opcode; 8] = [opcode!(inc; E/v), // 0x00: inc
...
pub static GROUP6_OPC00: [Opcode; 8] = [opcode!(sldt; M/w), // 0x00: sldt
...
pub static GROUP7_OPC01_MEM: [Opcode; 8] = [opcode!(sgdt; M/s), // 0x00: sgdt
...
pub static GROUP8_OPCBA: [Opcode; 8] =
    [unused!() /* 0x00 */, unused!() /* 0x01 */, unused!() /* 0x02 */, unused!() /* 0x03 */, opcode!(bt; E/v, I/b) /* 0x04: bt */, opcode!(bts; E/v, I/b) /* 0x05: bts */, opcode!(btr; E/v, I/b) /* 0x06: btr */, opcode!(btc; E/v, I/b) /* 0x07: btc */];

// GROUP9_C7

pub static GROUP10_OPCB9: [Opcode; 8] = [opcode!(ud1; ) /* 0x00 */, opcode!(ud1; ) /* 0x01 */, opcode!(ud1; ) /* 0x02 */, opcode!(ud1; ) /* 0x03 */, opcode!(ud1; ) /* 0x04 */, opcode!(ud1; ) /* 0x05 */, opcode!(ud1; ) /* 0x06 */, opcode!(ud1; ) /* 0x07 */];

pub static GROUP11_OPCC6: [Opcode; 8] = [opcode!(mov; E/b, I/b) /* 0x00: mov */, unused!() /* 0x01 */, unused!() /* 0x02 */, unused!() /* 0x03 */, unused!() /* 0x04 */, unused!() /* 0x05 */, unused!() /* 0x06 */, unused!() /* 0x07 */];

pub static GROUP11_OPCC7: [Opcode; 8] = [opcode!(mov; E/v, I/z) /* 0x00: mov */, unused!() /* 0x01 */, unused!() /* 0x02 */, unused!() /* 0x03 */, unused!() /* 0x04 */, unused!() /* 0x05 */, unused!() /* 0x06 */, unused!() /* 0x07 */];


pub static GROUP12_OPC71: [Opcode; 8] =
    [unused!() /* 0x00 */, unused!() /* 0x01 */, opcode!(psrlw; N/q, I/b) /* 0x02: psrlw */, unused!() /* 0x03 */, opcode!(psraw; N/q, I/b) /* 0x04: psraw */, unused!() /* 0x05 */, opcode!(psllw; N/q, I/b) /* 0x06: psllw */, unused!() /* 0x07 */];

pub static GROUP12_OPC6671: [Opcode; 8] = [unused!(), // 0x00
                                           unused!(), // 0x01
...
pub static GROUP13_OPC72: [Opcode; 8] =
    [unused!() /* 0x00 */, unused!() /* 0x01 */, opcode!(psrld; N/q, I/b) /* 0x02: psrld */, unused!() /* 0x03 */, opcode!(psrad; N/q, I/b) /* 0x04: psrad */, unused!() /* 0x05 */, opcode!(pslld; N/q, I/b) /* 0x06: pslld */, unused!() /* 0x07 */];

pub static GROUP13_OPC6672: [Opcode; 8] = [unused!(), // 0x00
                                           unused!(), // 0x01
...
pub static GROUP14_OPC73: [Opcode; 8] =
    [unused!() /* 0x00 */, unused!() /* 0x01 */, opcode!(psrlq; N/q, I/b) /* 0x02: psrlq */, unused!() /* 0x03 */, unused!() /* 0x04 */, unused!() /* 0x05 */, opcode!(psllq; N/q, I/b) /* 0x06: psllq */, unused!() /* 0x07 */];

pub static GROUP14_OPC6673: [Opcode; 8] = [unused!(), // 0x00
                                           unused!(), // 0x01
...
// GROUPX
pub static GROUP102_OPC01: [Opcode; 8] = [opcode!(sgdt; M/x), // 0x00: sgdt
...
pub static X87_D8_TABLE: [Opcode; 64] = [opcode!(fadd; ST0, ST0),
                                         opcode!(fadd; ST0, ST1),
                                         opcode!(fadd; ST0, ST2),
                                         opcode!(fadd; ST0, ST3),
                                         opcode!(fadd; ST0, ST4),
...
pub static X87_D9_TABLE: [Opcode; 64] = [opcode!(fld; ST0, ST0),
                                         opcode!(fld; ST0, ST1),
                                         opcode!(fld; ST0, ST2),
                                         opcode!(fld; ST0, ST3),
                                         opcode!(fld; ST0, ST4),
...
pub static X87_DA_TABLE: [Opcode; 64] = [opcode!(fcmovb; ST0, ST0),
...
pub static X87_DB_TABLE: [Opcode; 64] = [opcode!(fcmovnb; ST0, ST0),
...
pub static X87_DC_TABLE: [Opcode; 64] = [opcode!(fadd; ST0, ST0),
                                         opcode!(fadd; ST1, ST0),
                                         opcode!(fadd; ST2, ST0),
                                         opcode!(fadd; ST3, ST0),
                                         opcode!(fadd; ST4, ST0),
...
pub static X87_DD_TABLE: [Opcode; 64] = [opcode!(ffree; ST0),
                                         opcode!(ffree; ST1),
                                         opcode!(ffree; ST2),
                                         opcode!(ffree; ST3),
                                         opcode!(ffree; ST4),
                                         ...
                                         opcode!(fst1 ("fst"); ST6),
                                         opcode!(fst1 ("fst"); ST7),
                                         opcode!(fstp1 ("fstp"); ST0),
                                         opcode!(fstp1 ("fstp"); ST1),
                                         opcode!(fstp1 ("fstp"); ST2),
                                         opcode!(fstp1 ("fstp"); ST3),
                                         opcode!(fstp1 ("fstp"); ST4),
                                         opcode!(fstp1 ("fstp"); ST5),
                                         opcode!(fstp1 ("fstp"); ST6),
                                         opcode!(fstp1 ("fstp"); ST7),
...
pub static X87_DE_TABLE: [Opcode; 64] = [opcode!(faddp; ST0, ST0),
...
pub static X87_DF_TABLE: [Opcode; 64] = [unused!(),
                                         unused!(),
                                         unused!(),
                                         unused!(),
                                         unused!(),
...
pub static X87_D8_TABLE2: [Opcode; 8] = [opcode!(fadd; E/d, G/d), opcode!(fmul; E/d, G/d), opcode!(fcom; E/d, G/d), opcode!(fcomp; E/d, G/d), opcode!(fsub; E/d, G/d), opcode!(fsubr; E/d, G/d), opcode!(fdiv; E/d, G/d), opcode!(fdivr; E/d, G/d)];

pub static X87_D9_TABLE2: [Opcode; 8] = [opcode!(fld; E/d, G/d), unused!(), opcode!(fst2 ("fst"); E/d, G/d), opcode!(fstp2 ("fstp"); E/d, G/d), opcode!(fldenv; E/d, G/d), opcode!(fldcw; E/d, G/d), opcode!(fstenv; E/d, G/d), opcode!(fstcw; E/d, G/d)];

pub static X87_DA_TABLE2: [Opcode; 8] = [opcode!(fiadd; E/d, G/d), opcode!(fimul; E/d, G/d), opcode!(ficom; E/d, G/d), opcode!(ficomp; E/d, G/d), opcode!(fisub; E/d, G/d), opcode!(fisubr; E/d, G/d), opcode!(fidiv; E/d, G/d), opcode!(fidivr; E/d, G/d)];

pub static X87_DB_TABLE2: [Opcode; 8] = [opcode!(fild; E/d, G/d), opcode!(fisttp; E/d, G/d), opcode!(fist; E/d, G/d), opcode!(fistp; E/d, G/d), unused!(), opcode!(fld; E/dq, G/dq), unused!(), opcode!(fstp2 ("fstp"); E/dq, G/dq)];

pub static X87_DC_TABLE2: [Opcode; 8] = [opcode!(fadd; E/dq, G/dq), opcode!(fmul; E/dq, G/dq), opcode!(fcom; E/dq, G/dq), opcode!(fcomp; E/dq, G/dq), opcode!(fsub; E/dq, G/dq), opcode!(fsubr; E/dq, G/dq), opcode!(fdiv; E/dq, G/dq), opcode!(fdivr; E/dq, G/dq)];

pub static X87_DD_TABLE2: [Opcode; 8] = [opcode!(fld; E/dq, G/dq), opcode!(fisttp; E/d, G/d), opcode!(fst2 ("fst"); E/dq, G/dq), opcode!(fstp2 ("fstp"); E/dq, G/dq), opcode!(frstor; E/dq, G/dq), unused!(), opcode!(fsave; E/dq, G/dq), opcode!(fstsw2 ("fstsw"); E/dq, G/dq)];

pub static X87_DE_TABLE2: [Opcode; 8] = [opcode!(fiadd; E/w, G/w), opcode!(fimul; E/w, G/w), opcode!(ficom; E/w, G/w), opcode!(ficomp; E/w, G/w), opcode!(fisub; E/w, G/w), opcode!(fisubr; E/w, G/w), opcode!(fidiv; E/w, G/w), opcode!(fidivr; E/w, G/w)];

pub static X87_DF_TABLE2: [Opcode; 8] = [opcode!(fild; E/w, G/w), opcode!(fisttp; E/w, G/w), opcode!(fist; E/w, G/w), opcode!(fistp; E/w, G/w), opcode!(fbld; E/w, G/w), opcode!(fild; E/dq, G/dq), opcode!(fbstp; E/w, G/w), opcode!(fistp; E/dq, G/dq)];

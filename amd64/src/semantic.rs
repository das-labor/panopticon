...
fn reg_variants(name: &str) -> Option<(Lvalue, Lvalue, Lvalue, Lvalue, Lvalue)> {
    match name {
        "AL" | "AH" | "AX" | "EAX" | "RAX" => {
            Some((rreil_lvalue!{ AL:8 }, rreil_lvalue!{ AH:8 }, rreil_lvalue!{ AX:16 }, rreil_lvalue!{ EAX:32 }, rreil_lvalue!{ RAX:64 }))
        }
        "BL" | "BH" | "BX" | "EBX" | "RBX" => {
            Some((rreil_lvalue!{ BL:8 }, rreil_lvalue!{ BH:8 }, rreil_lvalue!{ BX:16 }, rreil_lvalue!{ EBX:32 }, rreil_lvalue!{ RBX:64 }))
        }
        "CL" | "CH" | "CX" | "ECX" | "RCX" => {
            Some((rreil_lvalue!{ CL:8 }, rreil_lvalue!{ CH:8 }, rreil_lvalue!{ CX:16 }, rreil_lvalue!{ ECX:32 }, rreil_lvalue!{ RCX:64 }))
        }
        "DL" | "DH" | "DX" | "EDX" | "RDX" => {
            Some((rreil_lvalue!{ DL:8 }, rreil_lvalue!{ DH:8 }, rreil_lvalue!{ DX:16 }, rreil_lvalue!{ EDX:32 }, rreil_lvalue!{ RDX:64 }))
        }
        "SIL" | "SIH" | "SI" | "ESI" | "RSI" => {
            Some((rreil_lvalue!{ SIL:8 }, rreil_lvalue!{ SIH:8 }, rreil_lvalue!{ SI:16 }, rreil_lvalue!{ ESI:32 }, rreil_lvalue!{ RSI:64 }))
        }
        "DIL" | "DIH" | "DI" | "EDI" | "RDI" => {
            Some((rreil_lvalue!{ DIL:8 }, rreil_lvalue!{ DIH:8 }, rreil_lvalue!{ DI:16 }, rreil_lvalue!{ EDI:32 }, rreil_lvalue!{ RDI:64 }))
        }
        "BPL" | "BP" | "EBP" | "RBP" => {
            Some((rreil_lvalue!{ BPL:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ BP:16 }, rreil_lvalue!{ EBP:32 }, rreil_lvalue!{ RBP:64 }))
        }
        "SPL" | "SP" | "ESP" | "RSP" => {
            Some((rreil_lvalue!{ SPL:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ SP:16 }, rreil_lvalue!{ ESP:32 }, rreil_lvalue!{ RSP:64 }))
        }
        "IP" | "EIP" | "RIP" => Some((rreil_lvalue!{ ? }, rreil_lvalue!{ ? }, rreil_lvalue!{ IP:16 }, rreil_lvalue!{ EIP:32 }, rreil_lvalue!{ RIP:64 })),
        "R8B" | "R8W" | "R8D" | "R8" => {
            Some((rreil_lvalue!{ R8B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R8W:16 }, rreil_lvalue!{ R8D:32 }, rreil_lvalue!{ R8:64 }))
        }
        "R9B" | "R9W" | "R9D" | "R9" => {
            Some((rreil_lvalue!{ R9B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R9W:16 }, rreil_lvalue!{ R9D:32 }, rreil_lvalue!{ R9:64 }))
        }
        "R10B" | "R10W" | "R10D" | "R10" => {
            Some((rreil_lvalue!{ R10B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R10W:16 }, rreil_lvalue!{ R10D:32 }, rreil_lvalue!{ R10:64 }))
        }
        "R11B" | "R11W" | "R11D" | "R11" => {
            Some((rreil_lvalue!{ R11B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R11W:16 }, rreil_lvalue!{ R11D:32 }, rreil_lvalue!{ R11:64 }))
        }
        "R12B" | "R12W" | "R12D" | "R12" => {
            Some((rreil_lvalue!{ R12B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R12W:16 }, rreil_lvalue!{ R12D:32 }, rreil_lvalue!{ R12:64 }))
        }
        "R13B" | "R13W" | "R13D" | "R13" => {
            Some((rreil_lvalue!{ R13B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R13W:16 }, rreil_lvalue!{ R13D:32 }, rreil_lvalue!{ R13:64 }))
        }
        "R14B" | "R14W" | "R14D" | "R14" => {
            Some((rreil_lvalue!{ R14B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R14W:16 }, rreil_lvalue!{ R14D:32 }, rreil_lvalue!{ R14:64 }))
        }
        "R15B" | "R15W" | "R15D" | "R15" => {
            Some((rreil_lvalue!{ R15B:8 }, rreil_lvalue!{ ? }, rreil_lvalue!{ R15W:16 }, rreil_lvalue!{ R15D:32 }, rreil_lvalue!{ R15:64 }))
        }
        _ => None,
    }
}
...
pub fn cmovcc(_: Rvalue, _: Rvalue, _: Condition) -> Result<(Vec<Statement>, JumpSpec)> {
    return Ok((vec![], JumpSpec::FallThru));
...
pub fn cmovo(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Overflow)
}
pub fn cmovno(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::NotOverflow)
}
pub fn cmovb(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Below)
}
pub fn cmovae(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::AboveEqual)
}
pub fn cmovz(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Equal)
}
pub fn cmovnz(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::NotEqual)
}
pub fn cmovbe(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::BelowEqual)
}
pub fn cmova(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Above)
}
pub fn cmovs(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Sign)
}
pub fn cmovns(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::NotSign)
}
pub fn cmovp(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Parity)
}
pub fn cmovnp(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::NotParity)
}
pub fn cmovl(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Less)
}
pub fn cmovle(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::LessEqual)
}
pub fn cmovg(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {
    cmovcc(a, b, Condition::Greater)
}
pub fn cmovge(a: Rvalue, b: Rvalue) -> Result<(Vec<Statement>, JumpSpec)> {

...
pub fn read_spec_register(
    ...
    match op {
        ...
        OperandType::ALR8B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R8B } else { Register::AL },
                )
            )
        }
        OperandType::CLR9B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R9B } else { Register::CL },
                )
            )
        }
        OperandType::DLR10B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R10B } else { Register::DL },
                )
            )
        }
        OperandType::BLR11B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R11B } else { Register::BL },
                )
            )
        }
        OperandType::AHR12B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R12B } else { Register::AH },
                )
            )
        }
        OperandType::CHR13B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R13B } else { Register::CH },
                )
            )
        }
        OperandType::DHR14B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R14B } else { Register::DH },
                )
            )
        }
        OperandType::BHR15B => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R15B } else { Register::BH },
                )
            )
        }
        ...
        OperandType::rAX | OperandType::eAX if opsz == 32 => {
            Ok(Operand::Register(Register::EAX))
        }
        OperandType::rBX | OperandType::eBX if opsz == 32 => {
            Ok(Operand::Register(Register::EBX))
        }
        OperandType::rCX | OperandType::eCX if opsz == 32 => {
            Ok(Operand::Register(Register::ECX))
        }
        OperandType::rDX | OperandType::eDX if opsz == 32 => {
            Ok(Operand::Register(Register::EDX))
        }
        OperandType::rDI | OperandType::eDI if opsz == 32 => {
            Ok(Operand::Register(Register::EDI))
        }
        OperandType::rSI | OperandType::eSI if opsz == 32 => {
            Ok(Operand::Register(Register::ESI))
        }
        OperandType::rSP | OperandType::eSP if opsz == 32 => {
            Ok(Operand::Register(Register::ESP))
        }
        OperandType::rBP | OperandType::eBP if opsz == 32 => {
            Ok(Operand::Register(Register::EBP))
        }

        OperandType::rAX | OperandType::eAX if opsz == 16 => {
            Ok(Operand::Register(Register::AX))
        }
        OperandType::rBX | OperandType::eBX if opsz == 16 => {
            Ok(Operand::Register(Register::BX))
        }
        OperandType::rCX | OperandType::eCX if opsz == 16 => {
            Ok(Operand::Register(Register::CX))
        }
        OperandType::rDX | OperandType::eDX if opsz == 16 => {
            Ok(Operand::Register(Register::DX))
        }
        OperandType::rDI | OperandType::eDI if opsz == 16 => {
            Ok(Operand::Register(Register::DI))
        }
        OperandType::rSI | OperandType::eSI if opsz == 16 => {
            Ok(Operand::Register(Register::SI))
        }
        OperandType::rSP | OperandType::eSP if opsz == 16 => {
            Ok(Operand::Register(Register::SP))
        }
        OperandType::rBP | OperandType::eBP if opsz == 16 => {
            Ok(Operand::Register(Register::BP))
        }

        OperandType::rAXr8 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R8 } else { Register::RAX },
                )
            )
        }
        OperandType::rCXr9 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R9 } else { Register::RCX },
                )
            )
        }
        OperandType::rDXr10 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R10 } else { Register::RDX },
                )
            )
        }
        OperandType::rBXr11 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R11 } else { Register::RBX },
                )
            )
        }
        OperandType::rSPr12 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R12 } else { Register::RSP },
                )
            )
        }
        OperandType::rBPr13 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R13 } else { Register::RBP },
                )
            )
        }
        OperandType::rSIr14 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R14 } else { Register::RSI },
                )
            )
        }
        OperandType::rDIr15 if opsz == 64 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R15 } else { Register::RDI },
                )
            )
        }

        OperandType::rAXr8 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R8D } else { Register::EAX },
                )
            )
        }
        OperandType::rCXr9 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R9D } else { Register::ECX },
                )
            )
        }
        OperandType::rDXr10 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R10D } else { Register::EDX },
                )
            )
        }
        OperandType::rBXr11 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R11D } else { Register::EBX },
                )
            )
        }
        OperandType::rSPr12 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R12D } else { Register::ESP },
                )
            )
        }
        OperandType::rBPr13 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R13D } else { Register::EBP },
                )
            )
        }
        OperandType::rSIr14 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R14D } else { Register::ESI },
                )
            )
        }
        OperandType::rDIr15 if opsz == 32 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R15D } else { Register::EDI },
                )
            )
        }

        OperandType::rAXr8 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R8W } else { Register::AX },
                )
            )
        }
        OperandType::rCXr9 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R9W } else { Register::CX },
                )
            )
        }
        OperandType::rDXr10 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R10W } else { Register::DX },
                )
            )
        }
        OperandType::rBXr11 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R11W } else { Register::BX },
                )
            )
        }
        OperandType::rSPr12 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R12W } else { Register::SP },
                )
            )
        }
        OperandType::rBPr13 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R13W } else { Register::BP },
                )
            )
        }
        OperandType::rSIr14 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R14W } else { Register::SI },
                )
            )
        }
        OperandType::rDIr15 if opsz == 16 => {
            Ok(
                Operand::Register(
                    if rex_b { Register::R15W } else { Register::DI },
                )
            )
        }
...
#[derive(Clone,Debug)]
pub struct OperandSpec(pub AddressingMethod, pub OperandType);
...
impl Display for Operand {
    fn fmt(&self, f: &mut Formatter) -> result::Result<(), Error> {
        match *self {
            ...
            Operand::Immediate(ref value, ref width) => {
                if *width < 64 {
...
fn read_operand(
    ...
    match (spec, opsz) {
        (&OperandSpec(AddressingMethod::None, ref reg), _) => {
            read_spec_register(
                reg.clone(),
                opsz,
                rex.unwrap_or((false, false, false, false)).3,
            )
        }
        (&OperandSpec(AddressingMethod::A, OperandType::v), 16) => {
            Ok(Operand::Immediate(tail.read_u16().ok().unwrap() as u64, 16))
        }
        (&OperandSpec(AddressingMethod::A, OperandType::v), 32) => {
            Ok(Operand::Immediate(tail.read_u32().ok().unwrap() as u64, 32))
        }
        (&OperandSpec(AddressingMethod::A, OperandType::v), 64) => {
            Ok(Operand::Immediate(tail.read_u64().ok().unwrap(), 64))
        }
        (&OperandSpec(AddressingMethod::A, OperandType::p), 16) => {
            Ok(Operand::Immediate(tail.read_u32().ok().unwrap() as u64, 32))
        }
        (&OperandSpec(AddressingMethod::A, OperandType::p), 32) => {
            let imm16 = tail.read_u16().ok().unwrap() as u64;
            let imm32 = tail.read_u32().ok().unwrap() as u64;
            Ok(Operand::Immediate((imm16 << 32) | imm32, 48))
        }
        (&OperandSpec(AddressingMethod::A, OperandType::p), 64) => {
            // XXX
            let _ = tail.read_u16().ok().unwrap();
            let imm64 = tail.read_u64().ok().unwrap();
            Ok(Operand::Immediate(imm64 as u64, 64))
        }
        (&OperandSpec(AddressingMethod::B, OperandType::y), opsz)
            if vvvv.is_some() => {
        ...
        // E
        (&OperandSpec(AddressingMethod::E, OperandType::v), opsz) => {
            indirect(
                try!(
        ...
        (&OperandSpec(AddressingMethod::E, OperandType::z), _) => {
            indirect(
                try!(
                    read_effective_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::E, OperandType::y), opsz) => {
            indirect(
                try!(
                    read_effective_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::E, OperandType::b), _) => {
            indirect(
                try!(
                    read_effective_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::E, OperandType::w), _) => {
            indirect(
                try!(
                    read_effective_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::E, OperandType::d), _) => {
            indirect(
                try!(
                    read_effective_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::E, OperandType::dq), _) => {
            indirect(
                try!(
                    read_effective_address(
                        mode,
        ...
        // G
        (&OperandSpec(AddressingMethod::G, OperandType::dq), _) => {
            read_register(tail.modrm(rex).ok().unwrap().1, rex.is_some(), 64)
        }
        (&OperandSpec(AddressingMethod::G, OperandType::d), _) => {
            read_register(tail.modrm(rex).ok().unwrap().1, rex.is_some(), 32)
        }
        (&OperandSpec(AddressingMethod::G, OperandType::w), _) => {
            read_register(tail.modrm(rex).ok().unwrap().1, rex.is_some(), 16)
        }
        (&OperandSpec(AddressingMethod::G, OperandType::b), _) => {
            read_register(tail.modrm(rex).ok().unwrap().1, rex.is_some(), 8)
        }
        (&OperandSpec(AddressingMethod::G, OperandType::v), opsz) => {
            read_register(tail.modrm(rex).ok().unwrap().1, rex.is_some(), opsz)
        }
        (&OperandSpec(AddressingMethod::G, OperandType::z), opsz) => {
            read_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                cmp::min(32, opsz),
            )
        }
        (&OperandSpec(AddressingMethod::G, OperandType::y), opsz) => {
            read_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                cmp::max(32, opsz),
        ...
        // H
        (&OperandSpec(AddressingMethod::H, OperandType::x), opsz)
            if vvvv.is_some() => {
            read_simd_register(vvvv.unwrap(), rex.is_some(), opsz)
        }
        (&OperandSpec(AddressingMethod::H, OperandType::qq), _)
            if vvvv.is_some() => {
            read_simd_register(vvvv.unwrap(), rex.is_some(), 256)
        }
        (&OperandSpec(AddressingMethod::H, OperandType::dq), _)
            if vvvv.is_some() => {
            read_simd_register(vvvv.unwrap(), rex.is_some(), 128)
        }
        (&OperandSpec(AddressingMethod::H, OperandType::ps), _)
            if vvvv.is_some() => {
            read_simd_register(vvvv.unwrap(), rex.is_some(), simdsz)
        }
        (&OperandSpec(AddressingMethod::H, OperandType::pd), _)
            if vvvv.is_some() => {
            read_simd_register(vvvv.unwrap(), rex.is_some(), simdsz)
        }
        (&OperandSpec(AddressingMethod::H, OperandType::ss), _)
            if vvvv.is_some() => {
            read_simd_register(vvvv.unwrap(), rex.is_some(), 128)
        }
        (&OperandSpec(AddressingMethod::H, OperandType::sd), _)
            if vvvv.is_some() => {
            read_simd_register(vvvv.unwrap(), rex.is_some(), 128)
        }
        (&OperandSpec(AddressingMethod::H, _), _) if vvvv.is_none() => {
            Ok(Operand::Optional)
        }

        (&OperandSpec(AddressingMethod::I, OperandType::z), 16) => {
            Ok(Operand::Immediate(tail.read_u16().ok().unwrap() as u64, 16))
        }
        (&OperandSpec(AddressingMethod::I, OperandType::z), _) => {
            Ok(Operand::Immediate(tail.read_u32().ok().unwrap() as u64, 32))
        }
        (&OperandSpec(AddressingMethod::I, OperandType::b), _) => {
            Ok(
                Operand::Immediate(
                    ((tail.read_u8().ok().unwrap() as i8) as i64) as u64,
                    opsz,
                )
            )
        }
        (&OperandSpec(AddressingMethod::I, OperandType::one), opsz) => {
            Ok(Operand::Immediate(1, opsz))
        }
        (&OperandSpec(AddressingMethod::I, OperandType::w), _) => {
            Ok(Operand::Immediate(tail.read_u16().ok().unwrap() as u64, 16))
        }
        (&OperandSpec(AddressingMethod::I, OperandType::v), 16) => {
            Ok(Operand::Immediate(tail.read_u16().ok().unwrap() as u64, 16))
        }
        (&OperandSpec(AddressingMethod::I, OperandType::v), 32) => {
            Ok(Operand::Immediate(tail.read_u32().ok().unwrap() as u64, 32))
        }
        (&OperandSpec(AddressingMethod::I, OperandType::v), 64) => {
            Ok(Operand::Immediate(tail.read_u64().ok().unwrap() as u64, 64))
        }
        (&OperandSpec(AddressingMethod::J,OperandType::b),_) =>
            Ok(Operand::Immediate(addr.wrapping_add(((tail.read_u8().ok().unwrap() as i8) as i64) as u64).wrapping_add(1),addrsz)),
        (&OperandSpec(AddressingMethod::J, OperandType::z), 16) => {
            Ok(
                Operand::Immediate(
                    addr.wrapping_add(
                            ((tail.read_u16().ok().unwrap() as i16) as i64) as
                            u64
                        )
                        .wrapping_add(2),
                    addrsz,
        ...
        (&OperandSpec(AddressingMethod::J, OperandType::z), _) => {
            Ok(
                Operand::Immediate(
                    addr.wrapping_add(
                            ((tail.read_u32().ok().unwrap() as i32) as i64) as
                            u64
                        )
                        .wrapping_add(4),
                    addrsz,
        ...
        (&OperandSpec(AddressingMethod::L, OperandType::x), 32) => {
            read_simd_register(
                tail.read_u8().ok().unwrap() & 0b0111,
                rex.is_some(),
                simdsz,
            )
        }
        (&OperandSpec(AddressingMethod::L, OperandType::x), _) => {
            read_simd_register(
                tail.read_u8().ok().unwrap() & 0b1111,
                rex.is_some(),
                simdsz,
            )
        }
        (&OperandSpec(AddressingMethod::M, OperandType::p), 16) => {
            read_effective_address(mode, seg, tail, rex, 16, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::p), 32) => {
            read_effective_address(mode, seg, tail, rex, 32, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::p), 64) => {
            read_effective_address(mode, seg, tail, rex, 64, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::w), _opsz) => {
            read_effective_address(mode, seg, tail, rex, 16, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::d), _opsz) => {
            read_effective_address(mode, seg, tail, rex, 32, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::q), _opsz) => {
            read_effective_address(mode, seg, tail, rex, 64, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::s), 64) => {
            read_effective_address(mode, seg, tail, rex, 80, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::s), _) => {
            read_effective_address(mode, seg, tail, rex, 48, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::b), _) => {
            read_effective_address(mode, seg, tail, rex, 8, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::None), opsz) => {
            read_effective_address(mode, seg, tail, rex, opsz, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::a), 32) => {
            read_effective_address(mode, seg, tail, rex, 64, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::a), 16) => {
            read_effective_address(mode, seg, tail, rex, 32, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::y), opsz) => {
            read_effective_address(
                mode,
                seg,
                tail,
        ...
        (&OperandSpec(AddressingMethod::M, OperandType::x), 32) => {
            read_effective_address(mode, seg, tail, rex, 128, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::M, OperandType::x), 64) => {
            read_effective_address(mode, seg, tail, rex, 256, addrsz, addr)
        }
        (&OperandSpec(AddressingMethod::N, OperandType::q), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().2,
                rex.is_some(),
                64,
            )
        }
        (&OperandSpec(AddressingMethod::O, OperandType::b), _) if addrsz ==
                                                                  16 => {
            read_memory(
                Operand::Immediate(tail.read_u16().ok().unwrap() as u64, addrsz),
                seg,
                addrsz,
                8,
            )
        ...
        (&OperandSpec(AddressingMethod::O, OperandType::b), _) if addrsz ==
                                                                  32 => {
            read_memory(
                Operand::Immediate(tail.read_u32().ok().unwrap() as u64, addrsz),
                seg,
                addrsz,
                8,
            )
        ...
        (&OperandSpec(AddressingMethod::O, OperandType::b), _) if addrsz ==
                                                                  64 => {
            read_memory(
                Operand::Immediate(tail.read_u64().ok().unwrap() as u64, addrsz),
                seg,
                addrsz,
                8,
            )
        }
        (&OperandSpec(AddressingMethod::O, OperandType::v), opsz) if addrsz ==
                                                                     16 => {
            read_memory(
                Operand::Immediate(tail.read_u16().ok().unwrap() as u64, addrsz),
                seg,
        ...
        (&OperandSpec(AddressingMethod::P, OperandType::pi), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                64,
        ...
        (&OperandSpec(AddressingMethod::P, OperandType::ps), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                simdsz,
        ...
        (&OperandSpec(AddressingMethod::P, OperandType::q), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                64,
        ...
        (&OperandSpec(AddressingMethod::P, OperandType::d), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                32,
        ...
        (&OperandSpec(AddressingMethod::Q, OperandType::d), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
                        seg,
                        tail,
                        rex,
        ...
        (&OperandSpec(AddressingMethod::Q, OperandType::pi), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::Q, OperandType::q), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::S, OperandType::w), _) => {
            read_memory(
                Operand::Immediate(tail.read_u16().ok().unwrap() as u64, addrsz),
                seg,
                addrsz,
        ...
        (&OperandSpec(AddressingMethod::R, OperandType::d), _) => {
            read_memory(
                Operand::Immediate(tail.read_u16().ok().unwrap() as u64, addrsz),
                seg,
                addrsz,
        ...
        (&OperandSpec(AddressingMethod::R, OperandType::q), _) => {
            read_memory(
                Operand::Immediate(tail.read_u16().ok().unwrap() as u64, addrsz),
                seg,
                addrsz,
        ...
        (&OperandSpec(AddressingMethod::U, OperandType::ps), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().2,
                rex.is_some(),
                simdsz,
        ...
        (&OperandSpec(AddressingMethod::U, OperandType::pi), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().2,
                rex.is_some(),
                64,
        ...
        (&OperandSpec(AddressingMethod::U, OperandType::q), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().2,
                rex.is_some(),
                64,
        ...
        (&OperandSpec(AddressingMethod::U, OperandType::x), 32) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().2,
                rex.is_some(),
                128,
        ...
        (&OperandSpec(AddressingMethod::U, OperandType::x), 64) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().2,
                rex.is_some(),
                256,
        ...
        (&OperandSpec(AddressingMethod::U, OperandType::dq), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().2,
                rex.is_some(),
                128,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::pi), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                64,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::ps), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                simdsz,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::pd), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                simdsz,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::ss), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                128,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::x), 32) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                128,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::x), 64) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                256,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::dq), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                128,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::q), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                64,
        ...
        (&OperandSpec(AddressingMethod::V, OperandType::sd), _) => {
            read_simd_register(
                tail.modrm(rex).ok().unwrap().1,
                rex.is_some(),
                128,
        ...
        (&OperandSpec(AddressingMethod::W, OperandType::pd), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::W, OperandType::ps), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::W, OperandType::q), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::W, OperandType::x), 64) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::W, OperandType::sd), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
        ...
        (&OperandSpec(AddressingMethod::W, OperandType::ss), _) => {
            indirect(
                try!(
                    read_effective_simd_address(
                        mode,
...
fn read_effective_simd_address(
    mode: Mode,
    seg: SegmentOverride,
    tail: &mut Tail,
    rex: Option<(bool, bool, bool, bool)>,
    ...
    match (mod_, rm & 0b111) {
        // mod = 00
        (0b00, 0b000) | (0b00, 0b001) | (0b00, 0b010) | (0b00, 0b011) |
        (0b00, 0b110) | (0b00, 0b111) => {
            read_simd_register(rm, rex.is_some(), addrsz)
        }
        (0b00, 0b100) => tail.sib(mod_, seg, rex, addrsz),
        (0b00, 0b101) if mode == Mode::Long => {
            Ok(
                Operand::Address(
                    ...
                    Register::None,
                    0,
                    (ip + sign_ext_u32(try!(tail.read_u32()), addrsz), addrsz),
                )
            )
        }
        (0b00, 0b101) if mode != Mode::Long => {
            Ok(
                Operand::Address(
                    ...
                    Register::None,
                    0,
                    (sign_ext_u32(try!(tail.read_u32()), addrsz), addrsz),
                )
            )
        }
        ...
        (0b01, 0b101) | (0b01, 0b110) | (0b01, 0b111) => {
            if let Ok(Operand::Register(reg)) =
                ...
                Ok(
                    Operand::Address(
                        ...
                        Register::None,
                        0,
                        (sign_ext_u8(try!(tail.read_u8()), addrsz), addrsz),
                    )
                )
            } else {
        ...
        (0b01, 0b100) => {
            if let Operand::Address(e, b, i, s, _) =
                try!(tail.sib(mod_, seg, rex, addrsz)) {
        ...
        (0b00, 0b101) if mode == Mode::Long => {
            ...
            Ok(
                Operand::Address(
                    ...
                    Register::None,
                    0,
                    (ip.wrapping_add(len).wrapping_add(imm), 32),
                )
            )
        }
        (0b00, 0b101) if mode != Mode::Long => {
            Ok(
                Operand::Address(
                    ...
                    Register::None,
                    0,
                    (sign_ext_u32(try!(tail.read_u32()), addrsz), 32),
                )
            )
        }
            ...
            if let Ok(Operand::Register(reg)) =
                ...
                Ok(
                    Operand::Address(
                        ...
                        Register::None,
                        0,
                        (sign_ext_u8(try!(tail.read_u8()), addrsz), 8),
                    )
                )
            } else {
...
fn read_memory(
    ...
    match op {
        Operand::Register(reg) => {
            Ok(Operand::Indirect(seg, reg, Register::None, 0, (0, 0), width))
        }
        Operand::Immediate(imm, w) => {
            Ok(
                Operand::Indirect(
                    seg,
                    Register::None,
        ...
        Operand::Address(seg, base, index, scale, disp) => {
            Ok(Operand::Indirect(seg, base, index, scale, disp, width))
        }
...
fn read_sib<R: ReadBytesExt>(
    ...
    let (ret_base, ret_disp) = if mod_ != 0b11 && base & 0b111 == 0b101 {
        match mod_ {
            0b00 => {
                (Register::None,
                 (sign_ext_u32(try!(fd.read_u32::<LittleEndian>()), addrsz),
                  32))
            }
        ...
        if let Ok(Operand::Register(r)) =
            read_register(base, rex.is_some(), addrsz) {
            (r, (0, 0))
        } else {
    ...
    let ret_index = if index & 0b111 == 0b100 {
        ...
        if let Ok(Operand::Register(r)) =
            read_register(index, rex.is_some(), addrsz) {
            r
        } else {
...
fn read_register(reg: u8, rex_present: bool, opsz: usize) -> Result<Operand> {
    match (reg, opsz) {
        ...
        (0b0100, 8) => {
            if !rex_present {
                Ok(Operand::Register(Register::AH))
            } else {
                Ok(Operand::Register(Register::SPL))
            }
        }
        (0b0101, 8) => {
            if !rex_present {
                Ok(Operand::Register(Register::CH))
            } else {
                Ok(Operand::Register(Register::BPL))
            }
        }
        (0b0110, 8) => {
            if !rex_present {
                Ok(Operand::Register(Register::DH))
            } else {
                Ok(Operand::Register(Register::SIL))
            }
        }
        (0b0111, 8) => {
            if !rex_present {
                Ok(Operand::Register(Register::BH))
            } else {
                Ok(Operand::Register(Register::DIL))
            }
        }
...
pub enum Opcode {
    Nonary(
        MnemonicSpec,
        OpcodeOption,
        fn() -> Result<(Vec<Statement>, JumpSpec)>
    ),
    Unary(
        MnemonicSpec,
        OpcodeOption,
        fn(Rvalue) -> Result<(Vec<Statement>, JumpSpec)>,
        OperandSpec
    ),
    Binary(
        MnemonicSpec,
        OpcodeOption,
        fn(Rvalue, Rvalue) -> Result<(Vec<Statement>, JumpSpec)>,
        OperandSpec,
        OperandSpec
    ),
    Trinary(
        MnemonicSpec,
        OpcodeOption,
        fn(Rvalue, Rvalue, Rvalue) -> Result<(Vec<Statement>, JumpSpec)>,
        OperandSpec,
        OperandSpec,
        OperandSpec
    ),
    Quaternary(
        MnemonicSpec,
        OpcodeOption,
        fn(Rvalue, Rvalue, Rvalue, Rvalue)
...
impl Opcode {
    pub fn operands<'a>(&'a self) -> Vec<&'a OperandSpec> {
        match *self {
            ...
            Opcode::Quaternary(_, _, _, ref a, ref b, ref c, ref d) => {
                vec![a, b, c, d]
            }
        }
    }
    ...
    pub fn call(
        ...
        match *self {
            ...
            Opcode::Unary(_, _, ref f, _) => {
                if let &Some(ref a) = a {
                    f(a.clone())
                } else {
                    Err(
                        "Internal error. Called 1-ary function with 0 arguments"
                            .into()
                    )
                }
            }
            Opcode::Binary(_, _, ref f, _, _) => {
            ...
            Opcode::Trinary(_, _, ref f, _, _, _) => {
                if let (&Some(ref a), &Some(ref b), &Some(ref c)) = (a, b, c) {
                    f(a.clone(), b.clone(), c.clone())
                } else {
                    Err("Internal error. Called 3-ary function less than 3 arguments".into())
                }
            }
            Opcode::Quaternary(_, _, ref f, _, _, _, _) => {
                if let (&Some(ref a),
                        &Some(ref b),
                        &Some(ref c),
                        &Some(ref d)) = (a, b, c, d) {
...
impl<'a> Tail<'a> {
    ...
    pub fn sib(
        ...
        if self.sib.is_none() {
            self.sib =
                Some(try!(read_sib(&mut self.fd, mod_, seg, rex, addrsz)));
        }
...
fn select_opcode_ext(
    ...
    Ok(
        match (grp, mo, pfx, opc) {
            ...
            (12, 0b11, SimdPrefix::Prefix66, 0x71) => {
                GROUP12_OPC6671[reg].clone()
            }

            // GROUP13
            (13, 0b11, SimdPrefix::None, 0x72) => GROUP13_OPC72[reg].clone(),
            (13, 0b11, SimdPrefix::Prefix66, 0x72) => {
                GROUP13_OPC6672[reg].clone()
            }

            // GROUP14
            (14, 0b11, SimdPrefix::None, 0x73) => GROUP14_OPC73[reg].clone(),
            (14, 0b11, SimdPrefix::Prefix66, 0x73) => {
                GROUP14_OPC6673[reg].clone()
            }

            // GROUP15
            (15, 0b11, SimdPrefix::None, 0xae) => {
                match reg {
                    0b101 => opcode!(lfence; ),
                    0b110 => opcode!(mfence; ),
                    0b111 => opcode!(sfence; ),
            ...
            (15, 0b11, SimdPrefix::PrefixF3, 0xae) => {
                match reg {
...
pub fn read(
    ...
    buf: &[u8],
    addr: u64,
) -> Result<(u64, Mnemonic, Vec<(Rvalue, Guard)>)> {
    use tables::*;
    ...
    while i < 15 {
        match buf.get(i) {
                ...
                if prefix.lock || prefix.repe || prefix.repne {
                    ...
                    match buf[i] {
                        ...
                        0xf2 => {
                            prefix.repne = true;
                            if i == 0 {
                                prefix.simd_prefix = SimdPrefix::PrefixF2;
                            }
                        }
                        0xf3 => {
                            prefix.repe = true;
                            if i == 0 {
                                prefix.simd_prefix = SimdPrefix::PrefixF3;
                            }
                        }
                        _ => unreachable!(),
                    }
            ...
            Some(&0x2e) | Some(&0x36) | Some(&0x3e) | Some(&0x26) |
            Some(&0x64) | Some(&0x65) => {
            ...
            // REX
            Some(&0x40) | Some(&0x41) | Some(&0x42) | Some(&0x43) |
            Some(&0x44) | Some(&0x45) | Some(&0x46) | Some(&0x47) |
            Some(&0x48) | Some(&0x49) | Some(&0x4a) | Some(&0x4b) |
            Some(&0x4c) | Some(&0x4d) | Some(&0x4e) | Some(&0x4f)
                if mode == Mode::Long => {
                let rex = buf[i];
    ...
    if prefix.opcode_escape == OpcodeEscape::Escape0F0F {
            ...
            OpcodeEscape::Escape0F => {
                if let Some(b) = buf.get(i) {
                    match *b {
                        ...
                        0x98...0x9f => true,
                        0xa8...0xaf => true,
                        0xb8...0xbf if prefix.simd_prefix !=
                                       SimdPrefix::PrefixF3 => true,
                        0xc0 | 0xc1 => true,
                        0xc8...0xcf => true,
                        _ => false,
                    }
        ...
        let opc = match (prefix.opcode_escape, prefix.simd_prefix) {
            ...
            (OpcodeEscape::Escape0F, SimdPrefix::None) => {
                TWOBYTE_TABLE[b].clone()
            }
            ...
            (OpcodeEscape::Escape0F, SimdPrefix::PrefixF2) => {
                TWOBYTE_F2_TABLE[b].clone()
            }
            (OpcodeEscape::Escape0F, SimdPrefix::PrefixF3) => {
                TWOBYTE_F3_TABLE[b].clone()
            }
            (OpcodeEscape::Escape0F3A, SimdPrefix::None) => {
                THREEBYTE_3A_TABLE[b].clone()
            }
            ...
            (OpcodeEscape::Escape0F3A, SimdPrefix::PrefixF3) => {
                return Err("Unknown instruction".into())
            }
            (OpcodeEscape::Escape0F3A, SimdPrefix::PrefixF2) => {
                THREEBYTE_3AF2_TABLE[b].clone()
            }
            (OpcodeEscape::Escape0F38, SimdPrefix::None) => {
                THREEBYTE_38_TABLE[b].clone()
            }
            ...
            (OpcodeEscape::Escape0F38, SimdPrefix::PrefixF3) => {
                THREEBYTE_38F3_TABLE[b].clone()
            }
            (OpcodeEscape::Escape0F38, SimdPrefix::PrefixF2) => {
                THREEBYTE_38F2_TABLE[b].clone()
            }
        ...
        match opc.option() {
            &OpcodeOption::Default64 if mode == Mode::Long &&
                                        prefix.operand_size == 32 => {
                prefix.operand_size = 64
            }
            ...
            &MnemonicSpec::Single(s) => {
                ...
                for op in opc.operands().iter() {
                    ...
                    match maybe_op {
                        ...
                        Err(e) => {
                            error!(
                                "error while decoding operands of '{}': {:?}",
                                s,
                                e
                            );
                            return Err(e);
                ...
                let (mut op_stmts, jmp_spec) = match res {
                    ...
                    Err(e) => {
                        error!(
                            "Semantic function for '{}' with {:?} failed: {}",
                            s,
                            ops,
                            e
                        );
...
fn to_rreil(op: Operand) -> Result<(Rvalue, Vec<Statement>)> {
    match op {
        ...
        Operand::Immediate(ref value, ref size) => {
            Ok(
                (Rvalue::Constant {
                     value: *value,
                     size: *size,

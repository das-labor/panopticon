...
impl Avalue for BoundedAddrTrack {
    ...
    fn abstract_constraint(constr: &Constraint) -> Self {
        if let &Constraint::Equal(Rvalue::Constant {
                                     ref value,
                                     ref size,
                                 }) = constr {
            BoundedAddrTrack::Offset {
    ...
    fn execute(
        ...
        match *op {
            // EvalOp
            Operation::And(BoundedAddrTrack::Offset {
                               region: None,
                               offset: ref val1,
                               offset_size: ref sz1,
                           },
            ...
            Operation::InclusiveOr(BoundedAddrTrack::Offset {
                                       region: None,
                                       offset: ref val1,
                                       offset_size: ref sz1,
                                   },
            ...
            Operation::ExclusiveOr(BoundedAddrTrack::Offset {
                                       region: None,
                                       offset: ref val1,
                                       offset_size: ref sz1,
                                   },
            ...
            Operation::Add(BoundedAddrTrack::Offset {
                               region: None,
                               offset: ref val1,
                               offset_size: ref sz1,
                           },
            ...
            Operation::Subtract(BoundedAddrTrack::Offset {
                                    region: None,
                                    offset: ref val1,
                                    offset_size: ref sz1,
                                },
            ...
            Operation::Multiply(BoundedAddrTrack::Offset {
                                    region: None,
                                    offset: ref val1,
                                    offset_size: ref sz1,
                                },
            ...
            Operation::DivideUnsigned(BoundedAddrTrack::Offset {
                                          region: None,
                                          offset: ref val1,
                                          offset_size: ref sz1,
                                      },
            ...
            Operation::DivideSigned(BoundedAddrTrack::Offset {
                                        region: None,
                                        offset: ref val1,
                                        offset_size: ref sz1,
                                    },
            ...
            Operation::Modulo(BoundedAddrTrack::Offset {
                                  region: None,
                                  offset: ref val1,
                                  offset_size: ref sz1,
                              },
            ...
            Operation::ShiftLeft(BoundedAddrTrack::Offset {
                                     region: None,
                                     offset: ref val1,
                                     offset_size: ref sz1,
                                 },
            ...
            Operation::ShiftRightUnsigned(BoundedAddrTrack::Offset {
                                              region: None,
                                              offset: ref val1,
                                              offset_size: ref sz1,
                                          },
            ...
            Operation::ShiftRightUnsigned(BoundedAddrTrack::Offset {
                ...
                addrtrack_op!(
                    Operation::ShiftRightUnsigned: r1,
                    r2,
                    val1,
                    val2,
                    sz1,
            ...
            Operation::ShiftRightSigned(BoundedAddrTrack::Offset {
                                            region: None,
                                            offset: ref val1,
                                            offset_size: ref sz1,
                                        },
            ...
            Operation::LessOrEqualSigned(BoundedAddrTrack::Offset {
                                             region: None,
                                             offset: ref val1,
                                             offset_size: ref sz1,
                                         },
            ...
            Operation::LessOrEqualSigned(BoundedAddrTrack::Offset {
                ...
                addrtrack_op!(
                    Operation::LessOrEqualSigned: r1,
                    r2,
                    val1,
                    val2,
                    sz1,
            ...
            Operation::LessOrEqualUnsigned(BoundedAddrTrack::Offset {
                                               region: None,
                                               offset: ref val1,
                                               offset_size: ref sz1,
                                           },
            ...
            Operation::LessOrEqualUnsigned(BoundedAddrTrack::Offset {
                ...
                addrtrack_op!(
                    Operation::LessOrEqualUnsigned: r1,
                    r2,
                    val1,
                    val2,
                    sz1,
            ...
            Operation::LessUnsigned(BoundedAddrTrack::Offset {
                                        region: None,
                                        offset: ref val1,
                                        offset_size: ref sz1,
                                    },
            ...
            Operation::LessSigned(BoundedAddrTrack::Offset {
                                      region: None,
                                      offset: ref val1,
                                      offset_size: ref sz1,
                                  },
            ...
            Operation::Equal(BoundedAddrTrack::Offset {
                                 region: None,
                                 offset: ref val1,
                                 offset_size: ref sz1,
                             },
    ...
    fn combine(&self, a: &Self) -> Self {
        if *a == *self {
            ...
            match (self, a) {
                ...
                (&BoundedAddrTrack::Region { region: ref a },
                 &BoundedAddrTrack::Region { region: ref b }) => {
                    if a == b {
                ...
                (&BoundedAddrTrack::Offset { region: ref a, .. },
                 &BoundedAddrTrack::Region { region: ref b }) => {
                    if a == b {
                        BoundedAddrTrack::Region { region: a.clone() }
                    } else {
                ...
                (&BoundedAddrTrack::Region { region: ref a },
                 &BoundedAddrTrack::Offset { region: ref b, .. }) => {
                    if a == b {
                        BoundedAddrTrack::Region { region: a.clone() }
                    } else {
                        BoundedAddrTrack::Join
    ...
    fn more_exact(&self, a: &Self) -> bool {
        if self == a {
            ...
            match (self, a) {
                ...
                (&BoundedAddrTrack::Region { .. },
                 &BoundedAddrTrack::Offset { .. }) => false,
                (&BoundedAddrTrack::Offset { .. },
                 &BoundedAddrTrack::Region { .. }) => true,
                (&BoundedAddrTrack::Region { .. },
                 &BoundedAddrTrack::Region { .. }) => false,
                (&BoundedAddrTrack::Offset { .. },
                 &BoundedAddrTrack::Offset { .. }) => false,
            }
        }
    ...
    fn extract(&self, size: usize, offset: usize) -> Self {
        match self {
            ...
            &BoundedAddrTrack::Region { region: ref r } => {
                BoundedAddrTrack::Region { region: r.clone() }
            }
            &BoundedAddrTrack::Offset {
                region: ref r,
                offset: ref v,
            ...
            match variant {
                ...
                1 | 2 => {
                    let reg = if g.gen::<bool>() {
                        let n =
                            Cow::Owned(g.gen_ascii_chars().take(1).collect());
                    ...
                    match variant {
                        1 => {
                            BoundedAddrTrack::Offset {
                                ...
                                offset_size: *g.choose(&[8, 16, 32, 64])
                                                  .unwrap(),
                            }
                        }
